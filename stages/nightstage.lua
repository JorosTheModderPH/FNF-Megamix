function onCreate()
	-- background shit
	makeLuaSprite('nightBack', 'nightBack', -600, -300);
	setLuaSpriteScrollFactor('nightBack', 0.9, 0.9);
	
	makeLuaSprite('nightFront', 'nightFront', -650, 600);
	setLuaSpriteScrollFactor('nightFront', 0.9, 0.9);
	scaleObject('nightFront', 1.1, 1.1);
