function onCreate()
	-- background shit
	makeLuaSprite('hexBack', 'hexBack', -600, -300);
	setLuaSpriteScrollFactor('hexBack', 0.9, 0.9);
	
	makeLuaSprite('hexFront', 'hexFront', -650, 600);
	setLuaSpriteScrollFactor('hexFront', 0.9, 0.9);
	scaleObject('hexFront', 1.1, 1.1);
