function onCreate()
	-- background shit
	makeLuaSprite('sunsetBack', 'sunsetBack', -600, -300);
	setLuaSpriteScrollFactor('sunsetBack', 0.9, 0.9);
	
	makeLuaSprite('sunsetFront', 'sunsetFront', -650, 600);
	setLuaSpriteScrollFactor('sunsetFront', 0.9, 0.9);
	scaleObject('sunsetFront', 1.1, 1.1);
